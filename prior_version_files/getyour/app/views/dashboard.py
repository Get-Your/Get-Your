...
from app.models import AddressRD, IQProgram, IQProgramRD, PlatformSettings
from app.constants import platform_settings_render_variables, platform_settings_render_variables
    ...
    try:
        ...
        return render(
            ...
            'dashboard/dashboard.html',
            {
                ...
                'required_renewal_text': PlatformSettings.objects.first(
                ).required_renewal_text,
                # TODO: Cache this PlatformSettings value (set on start and
                # when updated in the model)
                'renew_now_text': PlatformSettings.objects.first(
                ).renew_now_text,
